...
```javascript
MINUTES_IN_WEEK = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-time-minutes-in-week@v0.3.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-time-minutes-in-week@v0.3.0-umd/browser.js"></script>
```
