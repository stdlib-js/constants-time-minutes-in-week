...
```javascript
import MINUTES_IN_WEEK from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-time-minutes-in-week@v0.3.2-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/constants-time-minutes-in-week/actions/workflows/test.yml/badge.svg?branch=v0.3.2
[test-url]: https://github.com/stdlib-js/constants-time-minutes-in-week/actions/workflows/test.yml?query=branch:v0.3.2
